...
var BitgetWallet = class {
  constructor() {
    ...
    this.readyState = typeof window !== "undefined" ? (window == null ? void 0 : window.bitkeep) ? WalletReadyState.Installed : WalletReadyState.NotDetected : WalletReadyState.Unsupported;
  }
