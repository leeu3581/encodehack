...
export const EVM_CHAIN_ID_TO_NAME = invertMap(EVM_CHAINS);
export const EVM_TESTNET_CHAIN_ID_TO_NAME = invertMap(EVM_CHAINS_TESTNET);
export function evmChainIdToChainId(evmChainId, network = "MAINNET") {
    let chainName;
    if (network === "MAINNET")
        chainName = EVM_CHAIN_ID_TO_NAME[evmChainId];
    if (network === "TESTNET")
...
export function isTestnetEvm(chainId) {
    const ids = Object.values(EVM_CHAINS_TESTNET);
