...
exports.InjectedWallet = exports.InjectedWallets = void 0;
const injected_1 = require("@wagmi/core/connectors/injected");
const evm_1 = require("./evm");
var InjectedWallets;
(function (InjectedWallets) {
    InjectedWallets["MetaMask"] = "MetaMask";
    InjectedWallets["BitgetWallet"] = "Bitget Wallet";
    InjectedWallets["BraveWallet"] = "Brave Wallet";
    InjectedWallets["KuCoinWallet"] = "KuCoin Wallet";
    InjectedWallets["CoinbaseWallet"] = "Coinbase Wallet";
    InjectedWallets["FrontierWallet"] = "Frontier Wallet";
    InjectedWallets["BitKeepWallet"] = "BitKeep";
    InjectedWallets["OKXWallet"] = "OKX Wallet";
    InjectedWallets["RabbyWallet"] = "Rabby Wallet";
    InjectedWallets["Generic"] = "Injected Wallet";
    InjectedWallets["OktoWallet"] = "Okto Wallet";
})(InjectedWallets || (exports.InjectedWallets = InjectedWallets = {}));
...
class InjectedWallet extends evm_1.EVMWallet {
    constructor(config = {}) {
        super(config);
        this.config = config;
    }
    createConnector() {
        ...
        return new injected_1.InjectedConnector({
            chains: this.chains,
            options,
        });
    }
    ...
    getUrl() {
        ...
        switch (this.getName()) {
            case InjectedWallets.MetaMask:
                return "https://metamask.io/";
            case InjectedWallets.BitgetWallet:
                return "https://web3.bitget.com/";
            case InjectedWallets.BraveWallet:
                return "https://brave.com/";
            case InjectedWallets.KuCoinWallet:
                return "https://kuwallet.com/";
            case InjectedWallets.FrontierWallet:
                return "https://www.frontier.xyz/";
            case InjectedWallets.BitKeepWallet:
                return "https://bitkeep.com/";
            case InjectedWallets.OKXWallet:
                return "https://www.okx.com/web3/";
            case InjectedWallets.RabbyWallet:
    ...
    static getWalletType() {
        return evm_1.EVMWalletType.Injected;
    }
}
