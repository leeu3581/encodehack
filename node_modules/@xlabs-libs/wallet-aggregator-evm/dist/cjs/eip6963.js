...
exports.Eip6963Wallet = exports.Eip6963Wallets = void 0;
const core_1 = require("@wagmi/core");
const evm_1 = require("./evm");
const wallet_aggregator_core_1 = require("@xlabs-libs/wallet-aggregator-core");
class Eip6963Connector extends core_1.InjectedConnector {
    ...
    getProvider() {
        var _a;
        return (_a = this.wallet.detail) === null || _a === void 0 ? void 0 : _a.provider;
    }
}
/**
...
class Eip6963Wallet extends evm_1.EVMWallet {
    constructor(config) {
        super();
        this.detail = null;
        this.registerProvider = (event) => {
    ...
    createConnector() {
        window.removeEventListener("eip6963:announceProvider", this.registerProvider);
    ...
    getName() {
        var _a;
        return ((_a = this.detail) === null || _a === void 0 ? void 0 : _a.info.name) || this.name;
    }
    getUrl() {
    ...
    getIcon() {
        var _a;
        return ((_a = this.detail) === null || _a === void 0 ? void 0 : _a.info.icon) || this.details.icon;
    }
    getWalletState() {
