...
const metaMask_1 = require("@wagmi/core/connectors/metaMask");
class MetamaskWallet extends evm_1.EVMWallet {
    getUrl() {
    ...
    createConnector() {
        return new metaMask_1.MetaMaskConnector({
            chains: this.chains,
        });
    }
    getIcon() {
    ...
    static getWalletType() {
        return evm_1.EVMWalletType.Metamask;
    }
}
