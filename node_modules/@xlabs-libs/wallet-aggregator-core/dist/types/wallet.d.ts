...
export declare enum BaseFeatures {
...
export type BaseSubmitTransactionInput = any;
 ...
 */
export declare abstract class Wallet<CID extends ChainId = ChainId, ConnectOptions = any, SignTransactionInput = any, SignTransactionResult = any, SendTransactionInput = any, SendTransactionResultData = any, SignAndSendTransactionInput = SignTransactionInput, SignAndSendTransactionResultData = SendTransactionResultData, SignMessageInput = any, SignMessageResult = any, NetworkInfo = any, WalletFeatures = any, E extends WalletEvents = any> extends EventEmitter<E> {
     ...
     */
    abstract signTransaction(tx: SignTransactionInput): Promise<SignTransactionResult>;
    /**
     * @async
     ...
     */
    abstract sendTransaction(tx: SendTransactionInput): Promise<SendTransactionResult<SendTransactionResultData>>;
    /**
     * @async
     ...
     */
    abstract signAndSendTransaction(tx: SignAndSendTransactionInput): Promise<SendTransactionResult<SignAndSendTransactionResultData>>;
    /**
     ...
     */
    supportsFeature(feature: WalletFeatures | WalletFeatures[]): boolean;
    /**
