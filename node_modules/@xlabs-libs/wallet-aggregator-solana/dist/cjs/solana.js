 ...
 */
const getOverride = (adapter) => OVERRIDES.find((override) => override.name.toLocaleLowerCase().includes(adapter.name.toLocaleLowerCase())) || adapter;
/**
 ...
 * ```
 */
class SolanaWallet extends wallet_aggregator_core_1.Wallet {
    ...
    getChainId() {
        return wallet_aggregator_core_1.CHAIN_ID_SOLANA;
    }
    getAddress() {
        var _a;
        return (_a = this.adapter.publicKey) === null || _a === void 0 ? void 0 : _a.toString();
    }
    getAddresses() {
    ...
    sendTransaction(params) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ids = [];
            for (const tx of txs) {
                const id = yield this.adapter.sendTransaction(tx, this.connection, Object.assign({}, params.options));
                ids.push(id);
            }
            yield this.connection.confirmTransaction(ids[0], (_a = params.options) === null || _a === void 0 ? void 0 : _a.commitment);
            return {
                id: ids[0],
    ...
    getWalletState() {
        ...
        if (!(state in wallet_aggregator_core_1.WalletState)) {
            throw new Error(`Unknown wallet state ${state}`);
        }
        return wallet_aggregator_core_1.WalletState[state];
    }
    getFeatures() {
        const features = [
            wallet_aggregator_core_1.BaseFeatures.SendTransaction,
    ...
    supportsChain(chainId) {
        return chainId === wallet_aggregator_core_1.CHAIN_ID_SOLANA;
    }
}
