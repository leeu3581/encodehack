import { BaseFeatures, CHAIN_ID_SOLANA, Wallet, WalletState, } from "@xlabs-libs/wallet-aggregator-core";
const BITGET_WALLET = {
...
export class SolanaWallet extends Wallet {
    ...
    async sendTransaction(params) {
        ...
        await this.connection.confirmTransaction(ids[0], params.options?.commitment);
        return {
            id: ids[0],
