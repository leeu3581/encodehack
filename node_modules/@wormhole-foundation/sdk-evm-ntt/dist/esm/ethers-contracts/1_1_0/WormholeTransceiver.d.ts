...
export interface WormholeTransceiverInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "getTransceiverType", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "getTransceiverType", data: BytesLike): Result;
...
export interface WormholeTransceiver extends BaseContract {
    ...
    getFunction(nameOrSignature: "getTransceiverType"): TypedContractMethod<[], [string], "view">;
