...
import { a9 as u, aW as Y, aX as I, aY as x, aZ as ee, a_ as ne, a$ as se, O as M, bE as O, bF as ae, bG as E, bH as N, bI as B, bJ as _, br as U, r as te, f as b, e as ie, bs as D, ad as T, bq as re, ao as me, bt as R, bK as oe, bf as ue, g as le } from "./index-CGIqRhuR.mjs";
...
function W(t, e) {
  return new E(H.TokenMessengerIdl, new u(t), e === void 0 ? { connection: null } : e);
}
function Me(t, e) {
  return W(t, N(e));
}
function L(t, e) {
  return new E(H.MessageTransmitterIdl, new u(t), e === void 0 ? { connection: null } : e);
}
function Se(t, e) {
  return L(t, N(e));
}
...
function ke(t, e, s, a, i, n, r, m, l) {
  const d = o("message_transmitter", t), c = o("token_messenger", e), f = o("token_minter", e), p = o("local_token", e, [s]), S = o("remote_token_messenger", e, [a.toString()]), k = o("sender_authority", e), P = W(e), v = o("__event_authority", e);
...
async function he(t, e, s, a, i, n) {
  const r = M.Buffer.from(U.serialize(a)), m = M.Buffer.from(te.decode(i)), l = new u(s), d = new u(a.payload.burnToken.toUint8Array()), c = new b(a.payload.mintRecipient).unwrap(), f = n ? new u(n) : c, p = a.sourceDomain.toString(), S = o("message_transmitter", t), k = o("token_messenger", e), P = o("token_minter", e), v = o("local_token", e, [l]), V = o("remote_token_messenger", e, [p]), G = o("token_pair", e, [
    p,
    d
  ]), X = o("custody", e, [l]), $ = o("message_transmitter_authority", t, [e]).publicKey, q = F(a.nonce, a.sourceDomain, t), J = o("__event_authority", t), Z = o("__event_authority", e), g = [];
  g.push({
    isSigner: !1,
    isWritable: !1,
    pubkey: k.publicKey
