import { s as ce, T as N, o as ot, n as _t, R as Do, t as H, y as gt, a as C, p as K } from "./index-CDBL7oHs.mjs";
import { d as Uo } from "./dijkstra-BZM-8g-B.mjs";
import { O as Wo } from "./index-CGIqRhuR.mjs";
/**
 * @license
 ...
 */
var Ce;
const he = window, kr = he.trustedTypes, zo = kr ? kr.emptyScript : "", Tr = he.reactiveElementPolyfillSupport, ar = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? zo : null;
      break;
  ...
  return r;
} }, no = (e, t) => t !== e && (t == t || e == e), Ee = { attribute: !0, type: String, converter: ar, reflect: !1, hasChanged: no }, sr = "finalized";
let $t = class extends HTMLElement {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const o of n) r.unshift(Ir(o));
    } else t !== void 0 && r.push(Ir(t));
    return r;
  }
  static _$Ep(t, r) {
    const n = r.attribute;
  ...
  requestUpdate(t, r, n) {
    let o = !0;
    t !== void 0 && (((n = n || this.constructor.getPropertyOptions(t)).hasChanged || no)(this[t], r) ? (this._$AL.has(t) || this._$AL.set(t, r), n.reflect === !0 && this._$El !== t && (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(t, n))) : o = !1), !this.isUpdatePending && o && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
...
$t[sr] = !0, $t.elementProperties = /* @__PURE__ */ new Map(), $t.elementStyles = [], $t.shadowRootOptions = { mode: "open" }, Tr == null || Tr({ ReactiveElement: $t }), ((Ce = he.reactiveElementVersions) !== null && Ce !== void 0 ? Ce : he.reactiveElementVersions = []).push("1.6.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
var Ae;
const ue = window, It = ue.trustedTypes, Mr = It ? It.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, lr = "$lit$", rt = `lit$${(Math.random() + "").slice(9)}$`, io = "?" + rt, Fo = `<${io}>`, ft = document, Zt = () => ft.createComment(""), Vt = (e) => e === null || typeof e != "object" && typeof e != "function", ao = Array.isArray, Zo = (e) => ao(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", _e = `[ 	
\f\r]`, Pt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Sr = /-->/g, Or = />/g, lt = RegExp(`>|${_e}(?:([^\\s"'>=/]+)(${_e}*=${_e}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Rr = /'/g, Pr = /"/g, so = /^(?:script|style|textarea|title)$/i, lo = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), u = lo(1), L = lo(2), pt = Symbol.for("lit-noChange"), B = Symbol.for("lit-nothing"), Lr = /* @__PURE__ */ new WeakMap(), ut = ft.createTreeWalker(ft, 129, null, !1);
function co(e, t) {
...
const Vo = (e, t) => {
  ...
  for (let s = 0; s < r; s++) {
    const l = e[s];
    let c, d, y = -1, h = 0;
    for (; h < l.length && (a.lastIndex = h, d = a.exec(l), d !== null); ) h = a.lastIndex, a === Pt ? d[1] === "!--" ? a = Sr : d[1] !== void 0 ? a = Or : d[2] !== void 0 ? (so.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = lt) : d[3] !== void 0 && (a = lt) : a === lt ? d[0] === ">" ? (a = o ?? Pt, y = -1) : d[1] === void 0 ? y = -2 : (y = a.lastIndex - d[2].length, c = d[1], a = d[3] === void 0 ? lt : d[3] === '"' ? Pr : Rr) : a === Pr || a === Rr ? a = lt : a === Sr || a === Or ? a = Pt : (a = lt, o = void 0);
    const f = a === lt && e[s + 1].startsWith("/>") ? " " : "";
    i += a === Pt ? l + Fo : y >= 0 ? (n.push(c), l.slice(0, y) + lr + l.slice(y) + rt + f) : l + rt + (y === -2 ? (n.push(void 0), s) : f);
  }
...
class Kt {
  constructor({ strings: t, _$litType$: r }, n) {
    ...
    this.parts = [];
    let i = 0, a = 0;
    const s = t.length - 1, l = this.parts, [c, d] = Vo(t, r);
    ...
    for (; (o = ut.nextNode()) !== null && l.length < s; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) {
          const y = [];
          for (const h of o.getAttributeNames()) if (h.endsWith(lr) || h.startsWith(rt)) {
            const f = d[a++];
        ...
        if (so.test(o.tagName)) {
          ...
          if (h > 0) {
            ...
            for (let f = 0; f < h; f++) o.append(y[f], Zt()), ut.nextNode(), l.push({ type: 2, index: ++i });
            o.append(y[h], Zt());
          }
        }
      } else if (o.nodeType === 8) if (o.data === io) l.push({ type: 2, index: i });
      else {
        let y = -1;
        for (; (y = o.data.indexOf(rt, y + 1)) !== -1; ) l.push({ type: 7, index: i }), y += rt.length - 1;
      }
      i++;
    }
  }
...
function kt(e, t, r = e, n) {
  ...
  return (l == null ? void 0 : l.constructor) !== c && ((i = l == null ? void 0 : l._$AO) === null || i === void 0 || i.call(l, !1), c === void 0 ? l = void 0 : (l = new c(e), l._$AT(e, r, n)), n !== void 0 ? ((a = (s = r)._$Co) !== null && a !== void 0 ? a : s._$Co = [])[n] = l : r._$Cl = l), l !== void 0 && (t = kt(e, l._$AS(e, t.values), l, n)), t;
}
class Ko {
  constructor(t, r) {
  ...
  u(t) {
    ...
    for (; c !== void 0; ) {
      if (s === c.index) {
        let d;
        c.type === 2 ? d = new Jt(a, a.nextSibling, this, t) : c.type === 1 ? d = new c.ctor(a, c.name, c.strings, this, t) : c.type === 6 && (d = new Qo(a, this, t)), this._$AV.push(d), c = o[++l];
      }
...
class Jt {
  ...
  g(t) {
    var r;
    const { values: n, _$litType$: o } = t, i = typeof o == "number" ? this._$AC(t) : (o.el === void 0 && (o.el = Kt.createElement(co(o.h, o.h[0]), this.options)), o);
    if (((r = this._$AH) === null || r === void 0 ? void 0 : r._$AD) === i) this._$AH.v(n);
    else {
      const a = new Ko(i, this), s = a.u(this.options);
...
class ve {
  ...
  _$AI(t, r = this, n, o) {
    ...
    let a = !1;
    if (i === void 0) t = kt(this, t, r, 0), a = !Vt(t) || t !== this._$AH && t !== pt, a && (this._$AH = t);
    else {
      const s = t;
      let l, c;
      for (t = i[0], l = 0; l < i.length - 1; l++) c = kt(this, s[n + l], r, l), c === pt && (c = this._$AH[l]), a || (a = !Vt(c) || c !== this._$AH[l]), c === B ? t = B : t !== B && (t += (c ?? "") + i[l + 1]), this._$AH[l] = c;
    }
    a && !o && this.j(t);
  }
  j(t) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const rn = { ATTRIBUTE: 1 }, on = (e) => (...t) => ({ _$litDirective$: e, values: t });
class nn {
  constructor(t) {
  }
  get _$AU() {
...
const G = on(class extends nn {
  constructor(e) {
    var t;
    if (super(e), e.type !== rn.ATTRIBUTE || e.name !== "class" || ((t = e.strings) === null || t === void 0 ? void 0 : t.length) > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
  }
  render(e) {
...
const ho = (e, t, r) => Math.min(Math.max(r, e), t), Z = {
  duration: 0.3,
  delay: 0,
  endDelay: 0,
  repeat: 0,
...
function dn(e, t = cn(e.length), r = it) {
  ...
  return o > 0 && go(t, o), (i) => {
    ...
    for (; a < n - 2 && !(i < t[a + 1]); a++)
      ;
    let s = ho(0, 1, br(t[a], t[a + 1], i));
    return s = ln(r, a)(s), uo(e[a], e[a + 1], s);
  };
}
const fo = (e) => Array.isArray(e) && me(e[0]), cr = (e) => typeof e == "object" && !!e.createAnimation, Tt = (e) => typeof e == "function", hn = (e) => typeof e == "string", zt = {
  ms: (e) => e * 1e3,
  s: (e) => e / 1e3
}, po = (e, t, r) => (((1 - 3 * r + 3 * t) * e + (3 * r - 6 * t)) * e + 3 * t) * e, un = 1e-7, mn = 12;
function gn(e, t, r, n, o) {
  let i, a, s = 0;
  do
    a = t + (r - t) / 2, i = po(a, n, o) - e, i > 0 ? r = a : t = a;
  while (Math.abs(i) > un && ++s < mn);
  return a;
}
function jt(e, t, r, n) {
  if (e === t && r === n)
...
class wo {
  constructor(t, r = [0, 1], { easing: n, duration: o = Z.duration, delay: i = Z.delay, endDelay: a = Z.endDelay, repeat: s = Z.repeat, offset: l, direction: c = "normal", autoplay: d = !0 } = {}) {
    ...
    this.repeat = s, this.easing = Et(n) ? it : Dr(n), this.updateDuration(o);
    const y = dn(r, l, Et(n) ? n.map(Dr) : it);
    this.tick = (h) => {
      var f;
      i = i;
      let p = 0;
...
Wo.process.env.NODE_ENV !== "production" && (dr = function(e, t) {
  if (!e)
    throw new Error(t);
});
class vn {
...
function bn(e, t) {
  return e.has(t) || e.set(t, new vn()), e.get(t);
}
const yn = ["", "X", "Y", "Z"], xn = ["translate", "scale", "rotate", "skew"], ge = {
  x: "translateX",
  y: "translateY",
  z: "translateZ"
}, Ur = {
...
xn.forEach((e) => {
  yn.forEach((t) => {
    fe.push(e + t), qt.set(yr(e + t), $n[e]);
  });
});
const Cn = (e, t) => fe.indexOf(e) - fe.indexOf(t), En = new Set(fe), bo = (e) => En.has(e), An = (e, t) => {
  ge[t] && (t = ge[t]);
  const { transforms: r } = vo(e);
  an(r, t), e.style.transform = _n(r);
}, _n = (e) => e.sort(Cn).reduce(In, "").trim(), In = (e, t) => `${e} ${t}(var(${yr(t)}))`, hr = (e) => e.startsWith("--"), Wr = /* @__PURE__ */ new Set();
function kn(e) {
  if (!Wr.has(e)) {
    Wr.add(e);
    try {
...
const Se = (e, t) => document.createElement("div").animate(e, t), Hr = {
...
const Tn = 0.015, Mn = (e, t) => {
  let r = "";
  const n = Math.round(t / Tn);
  for (let o = 0; o < n; o++)
    r += e(br(0, n - 1, o)) + ", ";
  return r.substring(0, r.length - 2);
}, jr = (e, t) => Tt(e) ? Ct.linearEasing() ? `linear(${Mn(e, t)})` : Z.easing : fo(e) ? Sn(e) : e, Sn = ([e, t, r, n]) => `cubic-bezier(${e}, ${t}, ${r}, ${n})`;
function On(e, t) {
...
function ur(e) {
  return ge[e] && (e = ge[e]), bo(e) ? yr(e) : e;
}
const Xt = {
  get: (e, t) => {
    t = ur(t);
...
function Nn(e, t, r, n = {}, o) {
  ...
  let v = Ct.waapi();
  w && An(e, t);
  const E = ur(t), O = bn(b.values, E), R = qt.get(E);
  return yo(O.animation, !(cr(h) && O.generator) && n.record !== !1), () => {
    const U = () => {
      var P, Y;
    ...
    if (hr(E) && (Ct.cssRegisterProperty() ? kn(E) : v = !1), w && !Ct.linearEasing() && (Tt(h) || Et(h) && h.some(Tt)) && (v = !1), v) {
      R && (S = S.map((D) => me(D) ? R.toDefaultUnit(D) : D)), S.length === 1 && (!Ct.partialKeyframes() || a) && S.unshift(U());
      const P = {
        delay: zt.ms(c),
        duration: zt.ms(l),
        endDelay: zt.ms(d),
        easing: Et(h) ? void 0 : jr(h, l),
        direction: p,
        iterations: y + 1,
        fill: "both"
      };
      s = e.animate({
        [E]: S,
        offset: g,
        easing: Et(h) ? h.map((D) => jr(D, l)) : void 0
      }, P), s.finished || (s.finished = new Promise((D, Bo) => {
        s.onfinish = D, s.oncancel = Bo;
      }));
      const Y = S[S.length - 1];
      s.finished.then(() => {
        f || (Xt.set(e, E, Y), s.cancel());
      }).catch(mo), I || (s.playbackRate = 1.000001);
    } else if (o && w)
...
const Un = (e) => e(), xo = (e, t, r = Z.duration) => new Proxy({
  animations: e.map(Un).filter(Boolean),
  duration: r,
  options: t
}, Hn), Wn = (e) => e.animations[0], Hn = {
  get: (e, t) => {
    const r = Wn(e);
    switch (t) {
      case "duration":
      ...
      case "finished":
        return e.finished || (e.finished = Promise.all(e.animations.map(jn)).catch(mo)), e.finished;
      case "stop":
        return () => {
...
function Fn(e) {
  return function(r, n, o = {}) {
    ...
    for (let s = 0; s < i; s++) {
      ...
      for (const c in n) {
        const d = Bn(o, c);
        d.delay = zn(d.delay, s, i);
        const y = Nn(l, c, n[c], d, e);
        a.push(y);
      }
    }
    return xo(
...
Yt = Yt.replace(/u/g, "\\u");
const ti = "(?:(?![A-Z0-9 $%*+\\-./:]|" + Yt + `)(?:.|[\r
]))+`;
q.KANJI = new RegExp(Yt, "g");
q.BYTE_KANJI = new RegExp("[^A-Z0-9 $%*+\\-./:]+", "g");
q.BYTE = new RegExp(ti, "g");
q.NUMERIC = new RegExp(Mo, "g");
q.ALPHANUMERIC = new RegExp(Xn, "g");
const ei = new RegExp("^" + Yt + "$"), ri = new RegExp("^" + Mo + "$"), oi = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
var So = {};
const mr = F, Oo = 1335, ni = 21522, Fr = mr.getBCHDigit(Oo);
So.getEncodedBits = function(t, r) {
  const n = t.bit << 3 | r;
  let o = n << 10;
  for (; mr.getBCHDigit(o) - Fr >= 0; )
    o ^= Oo << mr.getBCHDigit(o) - Fr;
  return (n << 10 | o) ^ ni;
};
var Ro = {};
const ii = st;
function Mt(e) {
  this.mode = ii.NUMERIC, this.data = e.toString();
}
...
var fi = Rt;
(function(e) {
  const t = st, r = ai, n = li, o = ui, i = fi, a = q, s = F, l = Uo;
  function c(m) {
...
const $e = F, Pe = be, pi = Yn, wi = Jn, vi = Eo, bi = Ao, gr = _o, fr = ye, yi = Qn, we = To, xi = So, $i = st, Le = Ro;
function Ci(e, t) {
...
`
  ...
  const a = ki(t, r, o), s = $e.getSymbolSize(t), l = new wi(s);
...
Lo.render = function(t, r, n) {
  const o = Si.getOptions(r), i = t.modules.size, a = t.modules.data, s = i + o.margin * 2, l = o.color.light.a ? "<path " + Zr(o.color.light, "fill") + ' d="M0 0h' + s + "v" + s + 'H0z"/>' : "", c = "<path " + Zr(o.color.dark, "stroke") + ' d="' + Oi(a, i, o.margin) + '"/>', d = 'viewBox="0 0 ' + s + " " + s + '"', h = '<svg xmlns="http://www.w3.org/2000/svg" ' + (o.width ? 'width="' + o.width + '" height="' + o.width + '" ' : "") + d + ' shape-rendering="crispEdges">' + l + c + `</svg>
`;
  return typeof n == "function" && n(null, h), h;
};
const Ri = Kn, pr = $o, No = Po, Pi = Lo;
...
Gt.create = pr.create;
Gt.toCanvas = Ar.bind(null, No.render);
Gt.toDataURL = Ar.bind(null, No.renderToDataURL);
Gt.toString = Ar.bind(null, function(e, t, r) {
  return Pi.render(e, r);
});
var Li = Object.defineProperty, Vr = Object.getOwnPropertySymbols, Ni = Object.prototype.hasOwnProperty, Bi = Object.prototype.propertyIsEnumerable, Kr = (e, t, r) => t in e ? Li(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, De = (e, t) => {
  for (var r in t || (t = {})) Ni.call(t, r) && Kr(e, r, t[r]);
  if (Vr) for (var r of Vr(t)) Bi.call(t, r) && Kr(e, r, t[r]);
  return e;
};
function Di() {
  var e;
...
Q.styles = [_.globalCss, Ui], wt([$({ type: Boolean })], Q.prototype, "disabled", 2), wt([$()], Q.prototype, "iconLeft", 2), wt([$()], Q.prototype, "iconRight", 2), wt([$()], Q.prototype, "onClick", 2), wt([$()], Q.prototype, "variant", 2), Q = wt([k("wcm-button")], Q);
...
var zi = Object.defineProperty, Fi = Object.getOwnPropertyDescriptor, Ue = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? Fi(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
Lt.styles = [_.globalCss, ji], Ue([$({ type: Boolean })], Lt.prototype, "disabled", 2), Ue([$()], Lt.prototype, "variant", 2), Lt = Ue([k("wcm-button-big")], Lt);
const Zi = T`:host{background-color:var(--wcm-color-bg-2);border-top:1px solid var(--wcm-color-bg-3)}div{padding:10px 20px;display:inherit;flex-direction:inherit;align-items:inherit;width:inherit;justify-content:inherit}`;
var Vi = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
We.styles = [_.globalCss, Zi], We = Vi([k("wcm-info-footer")], We);
...
He.styles = [_.globalCss, Ki], He = qi([k("wcm-modal-backcard")], He);
const Yi = T`main{padding:20px;padding-top:0;width:100%}`;
var Ji = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
je.styles = [_.globalCss, Yi], je = Ji([k("wcm-modal-content")], je);
const Gi = T`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`;
var Qi = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
ze.styles = [_.globalCss, Gi], ze = Qi([k("wcm-modal-footer")], ze);
const Xi = T`header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`;
var ta = Object.defineProperty, ea = Object.getOwnPropertyDescriptor, Nt = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? ea(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
ct.styles = [_.globalCss, Xi], Nt([$()], ct.prototype, "title", 2), Nt([$()], ct.prototype, "onAction", 2), Nt([$()], ct.prototype, "actionIcon", 2), Nt([$({ type: Boolean })], ct.prototype, "border", 2), ct = Nt([k("wcm-modal-header")], ct);
...
} }, ra = T`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`;
var oa = Object.defineProperty, na = Object.getOwnPropertyDescriptor, Fe = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? na(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
Bt.styles = [_.globalCss, ra], Fe([j()], Bt.prototype, "view", 2), Fe([j()], Bt.prototype, "prevView", 2), Bt = Fe([k("wcm-modal-router")], Bt);
const ia = T`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`;
var aa = Object.defineProperty, sa = Object.getOwnPropertyDescriptor, Yr = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? sa(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
re.styles = [_.globalCss, ia], Yr([j()], re.prototype, "open", 2), re = Yr([k("wcm-modal-toast")], re);
const la = 0.1, Jr = 2.5, J = 7;
function Ze(e, t, r) {
...
const da = { generate(e, t, r) {
  ...
  return h.forEach(([p, g]) => {
    ...
    g.forEach((I) => {
      i.push(L`<circle cx="${p}" cy="${I}" fill="${n}" r="${s / Jr}">`);
    });
    ...
    g.forEach(([I, m]) => {
      i.push(L`<line x1="${p}" x2="${p}" y1="${I}" y2="${m}" stroke="${n}" stroke-width="${s / (Jr / 2)}" stroke-linecap="round">`);
    });
  }), i;
} }, ha = T`@keyframes fadeIn{0%{opacity:0}100%{opacity:1}}div{position:relative;user-select:none;display:block;overflow:hidden;aspect-ratio:1/1;animation:fadeIn ease .2s}.wcm-dark{background-color:#fff;border-radius:var(--wcm-container-border-radius);padding:18px;box-shadow:0 2px 5px #000}svg:first-child,wcm-wallet-image{position:absolute;top:50%;left:50%;transform:translateY(-50%) translateX(-50%)}wcm-wallet-image{transform:translateY(-50%) translateX(-50%)}wcm-wallet-image{width:25%;height:25%;border-radius:var(--wcm-wallet-icon-border-radius)}svg:first-child{transform:translateY(-50%) translateX(-50%) scale(.9)}svg:first-child path:first-child{fill:var(--wcm-accent-color)}svg:first-child path:last-child{stroke:var(--wcm-color-overlay)}`;
var ua = Object.defineProperty, ma = Object.getOwnPropertyDescriptor, vt = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? ma(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
X.styles = [_.globalCss, ha], vt([$()], X.prototype, "uri", 2), vt([$({ type: Number })], X.prototype, "size", 2), vt([$()], X.prototype, "imageId", 2), vt([$()], X.prototype, "walletId", 2), vt([$()], X.prototype, "imageUrl", 2), X = vt([k("wcm-qrcode")], X);
...
var fa = Object.defineProperty, pa = Object.getOwnPropertyDescriptor, Gr = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? pa(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
oe.styles = [_.globalCss, ga], Gr([$()], oe.prototype, "onChange", 2), oe = Gr([k("wcm-search-input")], oe);
const wa = T`@keyframes rotate{100%{transform:rotate(360deg)}}@keyframes dash{0%{stroke-dasharray:1,150;stroke-dashoffset:0}50%{stroke-dasharray:90,150;stroke-dashoffset:-35}100%{stroke-dasharray:90,150;stroke-dashoffset:-124}}svg{animation:rotate 2s linear infinite;display:flex;justify-content:center;align-items:center}svg circle{stroke-linecap:round;animation:dash 1.5s ease infinite;stroke:var(--wcm-accent-color)}`;
var va = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
Dt.styles = [_.globalCss, ba], Ke([$()], Dt.prototype, "variant", 2), Ke([$()], Dt.prototype, "color", 2), Dt = Ke([k("wcm-text")], Dt);
const $a = T`button{width:100%;height:100%;border-radius:var(--wcm-button-hover-highlight-border-radius);display:flex;align-items:flex-start}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}button>div{width:80px;padding:5px 0;display:flex;flex-direction:column;align-items:center}wcm-text{width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-align:center}wcm-wallet-image{height:60px;width:60px;transition:all .2s ease;border-radius:var(--wcm-wallet-icon-border-radius);margin-bottom:5px}.wcm-sublabel{margin-top:2px}`;
...
let V = class extends A {
  ...
  handleClick() {
    Do.click({ name: "WALLET_BUTTON", walletId: this.walletId }), this.onClick();
  }
  render() {
    var e;
...
V.styles = [_.globalCss, $a], tt([$()], V.prototype, "onClick", 2), tt([$()], V.prototype, "name", 2), tt([$()], V.prototype, "walletId", 2), tt([$()], V.prototype, "label", 2), tt([$()], V.prototype, "imageId", 2), tt([$({ type: Boolean })], V.prototype, "installed", 2), tt([$({ type: Boolean })], V.prototype, "recent", 2), V = tt([k("wcm-wallet-button")], V);
...
var _a = Object.defineProperty, Ia = Object.getOwnPropertyDescriptor, ne = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? Ia(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
bt.styles = [_.globalCss, Aa], ne([$()], bt.prototype, "walletId", 2), ne([$()], bt.prototype, "imageId", 2), ne([$()], bt.prototype, "imageUrl", 2), bt = ne([k("wcm-wallet-image")], bt);
var ka = Object.defineProperty, Ta = Object.getOwnPropertyDescriptor, Qr = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? Ta(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
Qr([j()], qe.prototype, "preload", 2), qe = Qr([k("wcm-explorer-context")], qe);
var Ma = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
Ye.styles = [_.globalCss, Sa], Ye = Oa([k("wcm-android-wallet-selection")], Ye);
...
var Pa = Object.defineProperty, La = Object.getOwnPropertyDescriptor, yt = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? La(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
et.styles = [_.globalCss, Ra], yt([$()], et.prototype, "walletId", 2), yt([$()], et.prototype, "imageId", 2), yt([$({ type: Boolean })], et.prototype, "isError", 2), yt([$({ type: Boolean })], et.prototype, "isStale", 2), yt([$()], et.prototype, "label", 2), et = yt([k("wcm-connector-waiting")], et);
const At = { manualWallets() {
  ...
  if (e) return u`<wcm-wallet-button name="${e.name}" walletId="${e.id}" imageId="${W(e.image_id)}" .recent="${!0}" .onClick="${() => this.onConnecting(e)}"></wcm-wallet-button>`;
} }, Na = T`.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between}.wcm-desktop-title,.wcm-mobile-title{display:flex;align-items:center}.wcm-mobile-title{justify-content:space-between;margin-bottom:20px;margin-top:-10px}.wcm-desktop-title{margin-bottom:10px;padding:0 10px}.wcm-subtitle{display:flex;align-items:center}.wcm-subtitle:last-child path{fill:var(--wcm-color-fg-3)}.wcm-desktop-title svg,.wcm-mobile-title svg{margin-right:6px}.wcm-desktop-title path,.wcm-mobile-title path{fill:var(--wcm-accent-color)}`;
var Ba = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
Je.styles = [_.globalCss, Na], Je = Ba([k("wcm-desktop-wallet-selection")], Je);
const Da = T`div{background-color:var(--wcm-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--wcm-color-bg-3);text-align:center}a{color:var(--wcm-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`;
var Ua = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
Ge.styles = [_.globalCss, Da], Ge = Ua([k("wcm-legal-notice")], Ge);
const Wa = T`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`;
var Ha = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
Qe.styles = [_.globalCss, Wa], Qe = Ha([k("wcm-mobile-wallet-selection")], Qe);
...
var za = Object.defineProperty, Fa = Object.getOwnPropertyDescriptor, Xe = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? Fa(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
Ut.styles = [_.globalCss, ja], Xe([j()], Ut.prototype, "open", 2), Xe([j()], Ut.prototype, "active", 2), Ut = Xe([k("wcm-modal")], Ut);
const Za = T`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
var Va = Object.defineProperty, Ka = Object.getOwnPropertyDescriptor, Wt = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? Ka(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
dt.styles = [_.globalCss, Za], Wt([$({ type: Boolean })], dt.prototype, "isMobile", 2), Wt([$({ type: Boolean })], dt.prototype, "isDesktop", 2), Wt([$({ type: Boolean })], dt.prototype, "isWeb", 2), Wt([$({ type: Boolean })], dt.prototype, "isRetry", 2), dt = Wt([k("wcm-platform-selection")], dt);
const qa = T`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`;
var Ya = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
tr.styles = [_.globalCss, qa], tr = Ya([k("wcm-view-all-wallets-button")], tr);
const Ja = T`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`;
var Ga = Object.defineProperty, Qa = Object.getOwnPropertyDescriptor, ie = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? Qa(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
xt.styles = [_.globalCss, Ja], ie([$()], xt.prototype, "walletId", 2), ie([$()], xt.prototype, "imageId", 2), ie([j()], xt.prototype, "uri", 2), xt = ie([k("wcm-walletconnect-qr")], xt);
var Xa = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
er.styles = [_.globalCss], er = Xa([k("wcm-connect-wallet-view")], er);
const ts = T`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var es = Object.defineProperty, rs = Object.getOwnPropertyDescriptor, to = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? rs(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
ae.styles = [_.globalCss, ts], to([j()], ae.prototype, "isError", 2), ae = to([k("wcm-desktop-connecting-view")], ae);
const os = T`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`;
var ns = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
rr.styles = [_.globalCss, os], rr = ns([k("wcm-install-wallet-view")], rr);
const is = T`wcm-wallet-image{border-radius:var(--wcm-wallet-icon-large-border-radius);width:96px;height:96px;margin-bottom:20px}wcm-info-footer{display:flex;width:100%}.wcm-app-store{justify-content:space-between}.wcm-app-store wcm-wallet-image{margin-right:10px;margin-bottom:0;width:28px;height:28px;border-radius:var(--wcm-wallet-icon-small-border-radius)}.wcm-app-store div{display:flex;align-items:center}.wcm-app-store wcm-button{margin-right:-10px}.wcm-note{flex-direction:column;align-items:center;padding:5px 0}.wcm-note wcm-text{text-align:center}wcm-platform-selection{margin-top:-15px}.wcm-note wcm-text{margin-top:15px}.wcm-note wcm-text span{color:var(--wcm-accent-color)}`;
var as = Object.defineProperty, ss = Object.getOwnPropertyDescriptor, eo = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? ss(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
se.styles = [_.globalCss, is], eo([j()], se.prototype, "isError", 2), se = eo([k("wcm-mobile-connecting-view")], se);
const ls = T`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var cs = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
or.styles = [_.globalCss, ls], or = cs([k("wcm-mobile-qr-connecting-view")], or);
var ds = (e, t, r, n) => {
  for (var o = t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = a(o) || o);
  return o;
};
...
nr.styles = [_.globalCss], nr = ds([k("wcm-qrcode-view")], nr);
const hs = T`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`;
var us = Object.defineProperty, ms = Object.getOwnPropertyDescriptor, Ht = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? ms(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
ht.styles = [_.globalCss, hs], Ht([j()], ht.prototype, "loading", 2), Ht([j()], ht.prototype, "firstFetch", 2), Ht([j()], ht.prototype, "search", 2), Ht([j()], ht.prototype, "endReached", 2), ht = Ht([k("wcm-wallet-explorer-view")], ht);
const gs = T`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`;
var fs = Object.defineProperty, ps = Object.getOwnPropertyDescriptor, ro = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? ps(t, r) : t, i = e.length - 1, a; i >= 0; i--) (a = e[i]) && (o = (n ? a(t, r, o) : a(o)) || o);
...
le.styles = [_.globalCss, gs], ro([j()], le.prototype, "isError", 2), le = ro([k("wcm-web-connecting-view")], le);
export {
  Ut as WcmModal,
  X as WcmQrCode
};
