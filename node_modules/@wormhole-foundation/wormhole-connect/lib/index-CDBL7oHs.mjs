const pe = Symbol(), ee = Object.getPrototypeOf, G = /* @__PURE__ */ new WeakMap(), me = (e) => e && (G.has(e) ? G.get(e) : ee(e) === Object.prototype || ee(e) === Array.prototype), ge = (e) => me(e) && e[pe] || null, te = (e, t = !0) => {
...
}, m = /* @__PURE__ */ new WeakMap(), p = [1, 1], E = (n) => {
  if (!q(n))
  ...
  if (h)
    return h;
  let I = p[0];
  const y = /* @__PURE__ */ new Set(), v = (i, a = ++p[0]) => {
    I !== a && (I = a, y.forEach((o) => o(i, a)));
  };
  let P = p[1];
  const O = (i = ++p[1]) => (P !== i && !y.size && (P = i, b.forEach(([a]) => {
    const o = a[1](i);
    o > I && (I = o);
  })), I), M = (i) => (a, o) => {
    const g = [...a];
    ...
    set(i, a, o, g) {
      const k = Reflect.has(i, a), T = Reflect.get(i, a, g);
      if (k && (e(T, o) || m.has(o) && e(T, m.get(o))))
        return !0;
      Z(a), q(o) && (o = ge(o) || o);
      let V = o;
      ...
      return Reflect.set(i, a, V, g), v(["set", [a], o, T]), !0;
    }
  });
  m.set(n, $);
  const fe = [
  ...
  return A.set($, fe), Reflect.ownKeys(n).forEach((i) => {
...
const d = j({ history: ["ConnectWallet"], view: "ConnectWallet", data: void 0 }), de = { state: d, subscribe(e) {
  ...
  var t, s;
  we.initialize(), w.setChains(e.chains), w.setIsAuth(!!e.enableAuthMode), w.setIsCustomMobile(!!((t = e.mobileWallets) != null && t.length)), w.setIsCustomDesktop(!!((s = e.desktopWallets) != null && s.length)), f.setModalVersionInStorage(), Object.assign(B, e);
} };
var Ie = Object.defineProperty, se = Object.getOwnPropertySymbols, Le = Object.prototype.hasOwnProperty, We = Object.prototype.propertyIsEnumerable, ne = (e, t, s) => t in e ? Ie(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : e[t] = s, Oe = (e, t) => {
...
async function K(e, t) {
  const s = Oe({ sdkType: X, sdkVersion: Y }, t), r = new URL(e, Q);
...
var Ee = Object.defineProperty, oe = Object.getOwnPropertySymbols, Ce = Object.prototype.hasOwnProperty, Ae = Object.prototype.propertyIsEnumerable, re = (e, t, s) => t in e ? Ee(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : e[t] = s, je = (e, t) => {
  for (var s in t || (t = {})) Ce.call(t, s) && re(e, s, t[s]);
  if (oe) for (var s of oe(t)) Ae.call(t, s) && re(e, s, t[s]);
  return e;
};
const ae = f.isMobile(), W = j({ wallets: { listings: [], total: 0, page: 1 }, search: { listings: [], total: 0, page: 1 }, recomendedWallets: [] }), Ne = { state: W, async getRecomendedWallets() {
  ...
  if (f.isArray(e)) {
    ...
    l.sort((c, m) => {
      const p = e.indexOf(c.id), E = e.indexOf(m.id);
      return p - E;
    }), W.recomendedWallets = l;
  } else {
    const { chains: s, isAuth: r } = w.state, l = s == null ? void 0 : s.join(","), c = f.isArray(t), m = { page: 1, sdks: r ? "auth_v1" : void 0, entries: f.RECOMMENDED_WALLET_AMOUNT, chains: l, version: 2, excludedIds: c ? t.join(",") : void 0 }, { listings: p } = ae ? await U.getMobileListings(m) : await U.getDesktopListings(m);
    W.recomendedWallets = Object.values(p);
  }
  return W.recomendedWallets;
}, async getWallets(e) {
  const t = je({}, e), { explorerRecommendedWalletIds: s, explorerExcludedWalletIds: r } = N.state, { recomendedWallets: l } = W;
  ...
  const { page: c, search: m } = e, { listings: p, total: E } = ae ? await U.getMobileListings(t) : await U.getDesktopListings(t), n = Object.values(p), h = m ? "search" : "wallets";
  return W[h] = { listings: [...W[h].listings, ...n], total: E, page: c ?? 1 }, { listings: n, total: E };
}, getWalletImageUrl(e) {
  ...
  return new Promise((t) => {
    ...
    if (f.removeWalletConnectDeepLink(), w.setWalletConnectUri(e == null ? void 0 : e.uri), w.setChains(e == null ? void 0 : e.chains), de.reset("ConnectWallet"), s && r) _.open = !0, t();
    else {
      const l = setInterval(() => {
        const c = w.state;
...
var Me = Object.defineProperty, ie = Object.getOwnPropertySymbols, Ue = Object.prototype.hasOwnProperty, Se = Object.prototype.propertyIsEnumerable, le = (e, t, s) => t in e ? Me(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : e[t] = s, De = (e, t) => {
  for (var s in t || (t = {})) Ue.call(t, s) && le(e, s, t[s]);
  if (ie) for (var s of ie(t)) Se.call(t, s) && le(e, s, t[s]);
  return e;
};
function Pe() {
  return typeof matchMedia < "u" && matchMedia("(prefers-color-scheme: dark)").matches;
}
const R = j({ themeMode: Pe() ? "dark" : "light" }), ce = { state: R, subscribe(e) {
  return D(R, () => e(R));
}, setThemeConfig(e) {
  const { themeMode: t, themeVariables: s } = e;
  t && (R.themeMode = t), s && (R.themeVariables = De({}, s));
} }, S = j({ open: !1, message: "", variant: "success" }), Te = { state: S, subscribe(e) {
  return D(S, () => e(S));
}, openToast(e, t) {
...
class ke {
  constructor(t) {
    this.openModal = F.open, this.closeModal = F.close, this.subscribeModal = F.subscribe, this.setTheme = ce.setThemeConfig, ce.setThemeConfig(t), N.setConfig(t), this.initUi();
  }
  async initUi() {
    if (typeof window < "u") {
      await import("./index-CrxcObQL.mjs");
