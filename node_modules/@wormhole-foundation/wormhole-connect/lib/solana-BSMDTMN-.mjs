import { Q as Zt, a9 as O, aa as st, T as Yt, ab as It, Z as ht, a3 as $, ac as Nt, ad as wt, ae as ct, af as Qt, ag as dt, ah as Dt, a7 as Z, ai as Ut, aj as kt, ak as St, al as Wt } from "./index-CGIqRhuR.mjs";
import { a as Gt } from "./util--bw7gFPs.mjs";
import { g as _t } from "./wallets-B2tqS5lZ.mjs";
import { d as vt, a as Pt } from "./signer-Dsw59ABd.mjs";
var xt = { exports: {} };
(function(s) {
  ...
  function n(u, r, o) {
    this.fn = u, this.context = r, this.once = o || !1;
  }
  function a(u, r, o, g, y) {
    if (typeof o != "function")
      throw new TypeError("The listener must be a function");
    var d = new n(o, g || u, y), I = t ? t + r : r;
    return u._events[I] ? u._events[I].fn ? u._events[I] = [u._events[I], d] : u._events[I].push(d) : (u._events[I] = d, u._eventsCount++), u;
  }
  function h(u, r) {
    --u._eventsCount === 0 ? u._events = new i() : delete u._events[r];
  }
  function l() {
  ...
  l.prototype.eventNames = function() {
    ...
    for (g in o = this._events)
      e.call(o, g) && r.push(t ? g.slice(1) : g);
    return Object.getOwnPropertySymbols ? r.concat(Object.getOwnPropertySymbols(o)) : r;
  }, l.prototype.listeners = function(r) {
    var o = t ? t + r : r, g = this._events[o];
    if (!g) return [];
    if (g.fn) return [g.fn];
    for (var y = 0, d = g.length, I = new Array(d); y < d; y++)
      I[y] = g[y].fn;
    return I;
  }, l.prototype.listenerCount = function(r) {
    var o = t ? t + r : r, g = this._events[o];
    return g ? g.fn ? 1 : g.length : 0;
  }, l.prototype.emit = function(r, o, g, y, d, I) {
    var A = t ? t + r : r;
    if (!this._events[A]) return !1;
    var M = this._events[A], L = arguments.length, j, N;
    if (M.fn) {
      switch (M.once && this.removeListener(r, M.fn, void 0, !0), L) {
        case 1:
          return M.fn.call(M.context), !0;
        case 2:
          return M.fn.call(M.context, o), !0;
        case 3:
          return M.fn.call(M.context, o, g), !0;
        case 4:
          return M.fn.call(M.context, o, g, y), !0;
        case 5:
          return M.fn.call(M.context, o, g, y, d), !0;
        case 6:
          return M.fn.call(M.context, o, g, y, d, I), !0;
      }
      for (N = 1, j = new Array(L - 1); N < L; N++)
        j[N - 1] = arguments[N];
      M.fn.apply(M.context, j);
    } else {
      var f = M.length, B;
      for (N = 0; N < f; N++)
        switch (M[N].once && this.removeListener(r, M[N].fn, void 0, !0), L) {
          case 1:
            M[N].fn.call(M[N].context);
            break;
          case 2:
            M[N].fn.call(M[N].context, o);
            break;
          case 3:
            M[N].fn.call(M[N].context, o, g);
            break;
          case 4:
            M[N].fn.call(M[N].context, o, g, y);
            break;
          default:
            if (!j) for (B = 1, j = new Array(L - 1); B < L; B++)
              j[B - 1] = arguments[B];
            M[N].fn.apply(M[N].context, j);
        }
    }
    return !0;
  }, l.prototype.on = function(r, o, g) {
    return a(this, r, o, g, !1);
  }, l.prototype.once = function(r, o, g) {
    return a(this, r, o, g, !0);
  }, l.prototype.removeListener = function(r, o, g, y) {
    var d = t ? t + r : r;
    ...
    if (I.fn)
      I.fn === o && (!y || I.once) && (!g || I.context === g) && h(this, d);
    else {
      for (var A = 0, M = [], L = I.length; A < L; A++)
        (I[A].fn !== o || y && !I[A].once || g && I[A].context !== g) && M.push(I[A]);
      M.length ? this._events[d] = M.length === 1 ? M[0] : M : h(this, d);
    }
    return this;
  }, l.prototype.removeAllListeners = function(r) {
    var o;
    return r ? (o = t ? t + r : r, this._events[o] && h(this, o)) : (this._events = new i(), this._eventsCount = 0), this;
...
class gt extends Ct {
    ...
    try {
      if (W(e)) {
        if (!this.supportedTransactionVersions)
          throw new k("Sending versioned transactions isn't supported by this wallet");
        if (!this.supportedTransactionVersions.has(e.version))
          throw new k(`Sending transaction version ${e.version} isn't supported by this wallet`);
        try {
          e = await this.signTransaction(e);
          const a = e.serialize();
          return await t.sendRawTransaction(a, i);
        } catch (a) {
          throw a instanceof m ? (n = !1, a) : new k(a == null ? void 0 : a.message, a);
        }
      } else
        try {
          const { signers: a, ...h } = i;
          e = await this.prepareTransaction(e, t, h), a != null && a.length && e.partialSign(...a), e = await this.signTransaction(e);
          const l = e.serialize();
          return await t.sendRawTransaction(l, h);
        } catch (a) {
          throw a instanceof m ? (n = !1, a) : new k(a == null ? void 0 : a.message, a);
        }
    } catch (a) {
      throw n && this.emit("error", a), a;
    }
  }
  async signAllTransactions(e) {
    for (const i of e)
      if (W(i)) {
        if (!this.supportedTransactionVersions)
          throw new m("Signing versioned transactions isn't supported by this wallet");
        if (!this.supportedTransactionVersions.has(i.version))
          throw new m(`Signing transaction version ${i.version} isn't supported by this wallet`);
      }
    const t = [];
    for (const i of e)
  ...
  async connect() {
    try {
      if (this.connected || this.connecting)
        return;
      if (this._readyState !== w.Installed)
        throw new Q();
      this._connecting = !0;
      ...
      try {
        ...
        throw new C(n == null ? void 0 : n.message, n);
      }
      let i;
      try {
        i = new O(t);
      } catch (n) {
        throw new v(n == null ? void 0 : n.message, n);
      }
  ...
  async signTransaction(e) {
    try {
      ...
      try {
        ...
        throw new m(i == null ? void 0 : i.message, i);
      }
    } catch (t) {
  ...
  async signMessage(e) {
    try {
      ...
      try {
        ...
        throw new F(i == null ? void 0 : i.message, i);
      }
    } catch (t) {
      throw this.emit("error", t), t;
    }
  ...
  async signTransaction(e) {
    try {
      ...
      if (!t)
        throw new T();
      try {
        const i = await t.request({ method: "sol_sign", params: [e] }), n = new O(i.publicKey), a = st.decode(i.signature);
        return e.addSignature(n, a), e;
      } catch (i) {
        throw new m(i == null ? void 0 : i.message, i);
      }
    } catch (t) {
  ...
  async signAllTransactions(e) {
    try {
      ...
      if (!t)
        throw new T();
      try {
        const i = await t.request({ method: "sol_signAllTransactions", params: [e] }), n = new O(i.publicKey), a = i.signatures;
        return e.map((h, l) => {
          const u = st.decode(a[l]);
          return h.addSignature(n, u), h;
        });
      } catch (i) {
        throw new m(i == null ? void 0 : i.message, i);
      }
...
class ee extends q {
  ...
  async connect() {
    try {
      ...
      let t;
      try {
        t = new O(e.publicKey.toBytes());
      } catch (i) {
        throw new v(i == null ? void 0 : i.message, i);
      }
...
class oe extends q {
  constructor({ params: e = { showTorusButton: !1 } } = { params: { showTorusButton: !1 } }) {
    super(), this.name = ce, this.url = "https://tor.us", this.icon = "data:image/svg+xml;base64,", this.supportedTransactionVersions = null, this._readyState = typeof window > "u" || typeof document > "u" ? w.Unsupported : w.Loadable, this._connecting = !1, this._wallet = null, this._publicKey = null, this._params = e;
  }
  get publicKey() {
    return this._publicKey;
  }
  ...
  async connect() {
    try {
      if (this.connected || this.connecting)
        return;
      if (this._readyState !== w.Loadable)
        throw new Q();
      this._connecting = !0;
      let e;
      try {
        e = (await import("./solanaEmbed.esm-CGNANvpZ.mjs")).default;
      } catch (a) {
      ...
      try {
        ...
        throw new P(a == null ? void 0 : a.message, a);
      }
      if (!t.isInitialized)
        try {
          await t.init(this._params);
        } catch (a) {
          throw new nt(a == null ? void 0 : a.message, a);
        }
      let i;
      try {
        i = await t.login();
      } catch (a) {
        throw new C(a == null ? void 0 : a.message, a);
      }
      let n;
      try {
        n = new O(i[0]);
      } catch (a) {
        throw new v(a == null ? void 0 : a.message, a);
      }
  ...
  async sendTransaction(e, t, i = {}) {
    try {
      ...
      try {
        const { signers: a, ...h } = i;
        e = await this.prepareTransaction(e, t, h), a != null && a.length && e.partialSign(...a), h.preflightCommitment = h.preflightCommitment || t.commitment;
        const { signature: l } = await n.signAndSendTransaction(e, h);
        return l;
      } catch (a) {
        throw a instanceof x ? a : new k(a == null ? void 0 : a.message, a);
      }
    } catch (n) {
...
const Me = "https://api.mainnet-beta.solana.com";
function le(s) {
  return s.includes(Me) ? At : /\bdevnet\b/i.test(s) ? ie : /\btestnet\b/i.test(s) ? ne : /\blocalhost\b/i.test(s) || /\b127\.0\.0\.1\b/.test(s) ? se : At;
}
const ue = "WalletConnect";
class ge extends gt {
  constructor(e) {
    super(), this.name = ue, this.url = "https://walletconnect.org", this.icon = "data:image/svg+xml;base64,", this.supportedTransactionVersions = /* @__PURE__ */ new Set(["legacy", 0]), this._readyState = typeof window > "u" ? w.Unsupported : w.Loadable, this._disconnected = () => {
      const t = this._wallet;
      t && (t.client.off("session_delete", this._disconnected), this._wallet = null, this._publicKey = null, this.emit("error", new ut()), this.emit("disconnect"));
  ...
  async connect() {
    try {
      ...
      let e, t;
      try {
        ({ WalletConnectWallet: e, WalletConnectChainID: t } = await import("./index-90fEVNZs.mjs"));
      } catch (a) {
        throw new Et(a == null ? void 0 : a.message, a);
      }
      let i, n;
      try {
        i = new e({
          network: this._config.network === H.Mainnet ? t.Mainnet : t.Devnet,
          options: this._config.options
        }), { publicKey: n } = await i.connect();
      } catch (a) {
        throw a.constructor.name === "QRCodeModalError" ? new Rt() : new nt(a == null ? void 0 : a.message, a);
      }
...
const Ie = {
  ...
  name: "Bitget Wallet"
}, he = [Ie], Ne = (s) => he.find((e) => e.name.toLocaleLowerCase().includes(s.name.toLocaleLowerCase())) || s, we = (s, e, t) => e[s] || t[s], Tt = (s, e) => we(s, Ne(e), e);
class b extends Yt {
  constructor(e, t) {
  ...
  async sendTransaction(e) {
    ...
    const n = [];
    for (const h of i) {
      const l = await this.adapter.sendTransaction(h, this.connection, {
        ...e.options
      });
      n.push(l);
    }
    return await this.connection.confirmTransaction(n[0], (a = e.options) == null ? void 0 : a.commitment), {
      id: n[0],
  ...
  getFeatures() {
    ...
    return this.adapter.signTransaction && this.adapter.signAllTransactions && e.push($.SignTransaction), this.adapter.signMessage && e.push($.SignMessage), e;
  }
  supportsChain(e) {
    return e === It;
  }
...
function de(s) {
  ...
  for (let r = 0; r < s.length; r++) {
    const o = s.charAt(r), g = o.charCodeAt(0);
    if (e[g] !== 255)
      throw new TypeError(o + " is ambiguous");
    e[g] = r;
  }
  const t = s.length, i = s.charAt(0), n = Math.log(t) / Math.log(256), a = Math.log(256) / Math.log(t);
  function h(r) {
    ...
    for (; y !== d && r[y] === 0; )
      y++, o++;
    const I = (d - y) * a + 1 >>> 0, A = new Uint8Array(I);
    for (; y !== d; ) {
      let j = r[y], N = 0;
      for (let f = I - 1; (j !== 0 || N < g) && f !== -1; f--, N++)
        j += 256 * A[f] >>> 0, A[f] = j % t >>> 0, j = j / t >>> 0;
      if (j !== 0)
  ...
  function l(r) {
    ...
    for (; r[o] === i; )
      g++, o++;
    const d = (r.length - o) * n + 1 >>> 0, I = new Uint8Array(d);
    for (; r[o]; ) {
      let j = e[r.charCodeAt(o)];
      if (j === 255)
        return;
      let N = 0;
      for (let f = d - 1; (j !== 0 || N < y) && f !== -1; f--, N++)
        j += t * I[f] >>> 0, I[f] = j % 256 >>> 0, j = j / 256 >>> 0;
      if (j !== 0)
        throw new Error("Non-zero carry");
      y = N, o++;
    }
...
var De = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz";
const ye = de(De);
var c = function(s, e, t, i) {
  if (t === "a" && !i) throw new TypeError("Private accessor was defined without a getter");
  if (typeof e == "function" ? s !== e || !i : !e.has(s)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
  return t === "m" ? i : t === "a" ? i.call(s) : i ? i.value : e.get(s);
}, z = function(s, e, t, i, n) {
...
}, S, E, G, _, U, R, et, D, it, ot, tt, Mt, J, lt, zt, mt, ft, Lt;
class je extends Ct {
  get name() {
    return c(this, D, "f").name;
  }
  get url() {
    return "https://github.com/solana-labs/wallet-standard";
  }
  get icon() {
    return c(this, D, "f").icon;
  }
  get readyState() {
    return c(this, it, "f");
  }
  ...
  constructor({ wallet: e }) {
    super(), S.add(this), E.set(this, void 0), G.set(this, void 0), _.set(this, void 0), U.set(this, void 0), R.set(this, void 0), et.set(this, void 0), D.set(this, void 0), it.set(this, typeof window > "u" || typeof document > "u" ? w.Unsupported : w.Installed), lt.set(this, (t) => {
      if ("accounts" in t) {
        const i = c(this, D, "f").accounts[0];
        c(this, E, "f") && !c(this, U, "f") && i !== c(this, E, "f") && (i ? c(this, S, "m", tt).call(this, i) : (this.emit("error", new ut()), c(this, S, "m", Mt).call(this)));
      }
      "features" in t && c(this, S, "m", J).call(this);
    }), z(this, D, e, "f"), z(this, E, null, "f"), z(this, G, null, "f"), z(this, _, !1, "f"), z(this, U, !1, "f"), z(this, R, c(this, D, "f").features[bt].on("change", c(this, lt, "f")), "f"), c(this, S, "m", J).call(this);
  }
  destroy() {
    z(this, E, null, "f"), z(this, G, null, "f"), z(this, _, !1, "f"), z(this, U, !1, "f");
    const e = c(this, R, "f");
    e && (z(this, R, null, "f"), e());
  }
  async autoConnect() {
    return c(this, S, "m", ot).call(this, { silent: !0 });
  }
  async connect() {
    return c(this, S, "m", ot).call(this);
  }
  async disconnect() {
    if (jt in c(this, D, "f").features)
      try {
        z(this, U, !0, "f"), await c(this, D, "f").features[jt].disconnect();
      } catch (e) {
        this.emit("error", new X(e == null ? void 0 : e.message, e));
      } finally {
        z(this, U, !1, "f");
      }
    c(this, S, "m", Mt).call(this);
  }
  async sendTransaction(e, t, i = {}) {
    try {
      const n = c(this, E, "f");
      if (!n)
        throw new T();
      let a;
      if (Y in c(this, D, "f").features)
        if (n.features.includes(Y))
          a = Y;
        else if (p in c(this, D, "f").features && n.features.includes(p))
          a = p;
        else
          throw new C();
      else if (p in c(this, D, "f").features) {
        if (!n.features.includes(p))
          throw new C();
        a = p;
      } else
        throw new P();
      const h = le(t.rpcEndpoint);
      if (!n.chains.includes(h))
        throw new k();
      try {
        const { signers: l, ...u } = i;
        let r;
        if (W(e) ? (l != null && l.length && e.sign(l), r = e.serialize()) : (e = await this.prepareTransaction(e, t, u), l != null && l.length && e.partialSign(...l), r = new Uint8Array(e.serialize({
          requireAllSignatures: !1,
          verifySignatures: !1
        }))), a === Y) {
          const [o] = await c(this, D, "f").features[Y].signAndSendTransaction({
            account: n,
            chain: h,
            transaction: r,
            options: {
              preflightCommitment: rt(u.preflightCommitment || t.commitment),
              skipPreflight: u.skipPreflight,
              maxRetries: u.maxRetries,
              minContextSlot: u.minContextSlot
            }
          });
          return ye.encode(o.signature);
        } else {
          const [o] = await c(this, D, "f").features[p].signTransaction({
            account: n,
            chain: h,
            transaction: r,
            options: {
        ...
        throw l instanceof x ? l : new k(l == null ? void 0 : l.message, l);
      }
    } catch (n) {
      throw this.emit("error", n), n;
    }
...
E = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), et = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), it = /* @__PURE__ */ new WeakMap(), lt = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakSet(), ot = async function(e) {
  try {
    if (this.connected || this.connecting)
      return;
    if (c(this, it, "f") !== w.Installed)
      throw new Q();
    if (z(this, _, !0, "f"), !c(this, D, "f").accounts.length)
      try {
        await c(this, D, "f").features[Ot].connect(e);
      } catch (i) {
        throw new nt(i == null ? void 0 : i.message, i);
      }
    const t = c(this, D, "f").accounts[0];
    if (!t)
      throw new C();
    c(this, S, "m", tt).call(this, t);
  } catch (t) {
    throw this.emit("error", t), t;
  } finally {
    z(this, _, !1, "f");
  ...
  z(this, E, e, "f"), z(this, G, t, "f"), c(this, S, "m", J).call(this), this.emit("connect", t);
}, Mt = function() {
  z(this, E, null, "f"), z(this, G, null, "f"), c(this, S, "m", J).call(this), this.emit("disconnect");
}, J = function() {
  var t, i;
  const e = Y in c(this, D, "f").features ? c(this, D, "f").features[Y].supportedTransactionVersions : c(this, D, "f").features[p].supportedTransactionVersions;
  z(this, et, Gt(e, ["legacy"]) ? null : new Set(e), "f"), p in c(this, D, "f").features && ((t = c(this, E, "f")) != null && t.features.includes(p)) ? (this.signTransaction = c(this, S, "m", zt), this.signAllTransactions = c(this, S, "m", mt)) : (delete this.signTransaction, delete this.signAllTransactions), V in c(this, D, "f").features && ((i = c(this, E, "f")) != null && i.features.includes(V)) ? this.signMessage = c(this, S, "m", ft) : delete this.signMessage, at in c(this, D, "f").features ? this.signIn = c(this, S, "m", Lt) : delete this.signIn;
}, zt = async function(e) {
  try {
    const t = c(this, E, "f");
    if (!t)
      throw new T();
    if (!(p in c(this, D, "f").features))
      throw new P();
    if (!t.features.includes(p))
      throw new C();
    try {
      const n = (await c(this, D, "f").features[p].signTransaction({
        account: t,
      ...
      return W(e) ? Nt.deserialize(n) : wt.from(n);
    } catch (i) {
      throw i instanceof x ? i : new m(i == null ? void 0 : i.message, i);
    }
  } catch (t) {
    throw this.emit("error", t), t;
  }
  ...
  try {
    ...
    if (!t.features.includes(p))
      throw new C();
    try {
      const i = await c(this, D, "f").features[p].signTransaction(...e.map((n) => ({
        account: t,
      ...
      return e.map((n, a) => {
        const h = i[a].signedTransaction;
        return W(n) ? Nt.deserialize(h) : wt.from(h);
      });
    } catch (i) {
      throw new m(i == null ? void 0 : i.message, i);
    }
  ...
  try {
    ...
    if (!t)
      throw new T();
    if (!(V in c(this, D, "f").features))
      throw new P();
    if (!t.features.includes(V))
      throw new C();
    try {
      return (await c(this, D, "f").features[V].signMessage({
        account: t,
        message: e
      }))[0].signature;
    } catch (i) {
  ...
  try {
    if (!(at in c(this, D, "f").features))
      throw new P();
    let t;
    try {
      [t] = await c(this, D, "f").features[at].signIn(e);
    } catch (i) {
      throw new yt(i == null ? void 0 : i.message, i);
    }
    if (!t)
      throw new yt();
    return c(this, S, "m", tt).call(this, t.account), t;
  } catch (t) {
    throw this.emit("error", t), t;
  }
};
function Ae(s) {
  return _t().get().filter(Jt).map((e) => new b(new je({ wallet: e }), s));
}
function Te(s) {
  return s.includes("rpcpool.com") ? "triton" : s.includes("helius-rpc.com") ? "helius" : s.includes("rpc.ankr.com") ? "ankr" : "unknown";
}
async function ze(s, e, t, i) {
  const n = i.transaction.transaction, a = (h) => h.programId.toString() !== "ComputeBudget111111111111111111111111111111";
  if (ct(n)) {
    const h = (await Promise.all(
      n.message.addressTableLookups.map(
        (u) => s.getAddressLookupTable(u.accountKey)
      )
    )).map((u) => u.value).filter((u) => u !== null), l = Qt.decompile(n.message, {
      addressLookupTableAccounts: h
    });
    l.recentBlockhash = e, n.message.recentBlockhash = e, l.instructions = l.instructions.filter(a), l.instructions.push(
      ...await pt(s, n)
    ), n.message = l.compileToV0Message(h), n.sign(i.transaction.signers ?? []);
  } else
    n.recentBlockhash = e, n.lastValidBlockHeight = t, n.instructions = n.instructions.filter(
      a
    ), n.add(
      ...await pt(s, n)
    ), i.transaction.signers && n.partialSign(...i.transaction.signers);
  return n;
}
async function pt(s, e, t) {
  ...
  let i = 2e5, n = 0;
  t: for (; ; ) {
    if (ct(e) && !e.message.recentBlockhash) {
      const { blockhash: f } = await s.getLatestBlockhash(t);
      e.message.recentBlockhash = f;
    }
    const N = await (ct(e) ? s.simulateTransaction(e, {
      commitment: t,
      replaceRecentBlockhash: !0
    }) : s.simulateTransaction(e));
    if (N.value.err) {
      if (me(N.value)) {
        if (n < 5) {
          n++, await dt(1e3);
      ...
      throw new Error(
        `Simulation failed: ${JSON.stringify(N.value.err)}
Logs:
${(N.value.logs || []).join(`
  `)}`
      );
    } else {
      N.value.unitsConsumed && (i = N.value.unitsConsumed);
      break;
    }
  }
  const a = Math.floor(i * 1.2), h = [];
  h.push(
    Dt.setComputeUnitLimit({
      // Set compute budget to 120% of the units used in the simulated transaction
      units: a
    })
  );
  const l = ((j = (L = Z.transactionSettings) == null ? void 0 : L.Solana) == null ? void 0 : j.priorityFee) || {}, {
    percentile: u = 0.9,
    percentileMultiple: r = 1,
    min: o = 1e5,
    max: g = 1e8
  } = l, y = async (N) => {
    if (N === "triton")
      try {
        ...
        console.warn("Failed to determine priority fee using Triton RPC:", f);
      }
    try {
      return {
        fee: await Pt(
      ...
      return console.warn("Failed to determine priority fee using Triton RPC:", f), {
        fee: o,
        methodUsed: "minimum"
      };
    }
  }, d = Te(s.rpcEndpoint), { fee: I, methodUsed: A } = await y(d), M = I / // convert microlamports to lamports
  1e6 / // convert lamports to SOL
  kt * // multiply by maximum compute units used
  a;
  return console.table({
    ...
    Dt.setComputeUnitPrice({ microLamports: I })
  ), h;
}
function me(s) {
  const e = {};
  if (s.err === "BlockhashNotFound" && (e.BlockhashNotFound = "Blockhash not found during simulation. Trying again."), s.logs)
    for (const t of s.logs)
      t.includes("SlippageToleranceExceeded") && (e.SlippageToleranceExceeded = "Slippage failure during simulation. Trying again."), t.includes("RequireGteViolated") && (e.RequireGteViolated = "Swap instruction failure during simulation. Trying again.");
  return Ut(e) ? !1 : (console.table(e), !0);
}
const fe = (s) => s.getName().toLowerCase().replaceAll("wallet", "").trim();
function Ee() {
  const s = Z.isMainnet ? "mainnet-beta" : "devnet", e = new St(Z.rpcs.Solana || Wt(s));
  return {
    ...Ae(e).reduce((t, i) => (t[fe(i)] = i, t), {}),
    bitget: new b(new Xt(), e),
    clover: new b(new Kt(), e),
    coin98: new b(new $t(), e),
    solong: new b(new re(), e),
    torus: new b(new oe(), e),
    nightly: new b(new ee(), e),
    ...Z.ui.walletConnectProjectId ? {
      walletConnect: new b(
        new ge({
          network: Z.isMainnet ? H.Mainnet : H.Devnet,
          options: {
            projectId: Z.ui.walletConnectProjectId,
...
async function Ce(s, e, t) {
  if (!e) throw new Error("Wallet not found");
  if (!Z.rpcs.Solana) throw new Error("Solana RPC not found");
  const i = (t == null ? void 0 : t.commitment) ?? "finalized", n = new St(Z.rpcs.Solana), { blockhash: a, lastValidBlockHeight: h } = await n.getLatestBlockhash(i), l = await ze(
    n,
    a,
    h,
    s
  );
  let u = null, r = null, o = 1, g = "";
  const d = (await e.signTransaction(l)).serialize(), I = {
    skipPreflight: !0,
    maxRetries: 0,
    preFlightCommitment: i
    // See PR and linked issue for why setting this matters: https://github.com/anza-xyz/agave/pull/483
  };
  g = await n.sendRawTransaction(d, I), u = n.confirmTransaction(
    {
      signature: g,
      blockhash: a,
  ...
  for (; !r && (r = await Promise.race([
    ...
    console.log(
      `Tx not confirmed after ${A * o++}ms, resending`
    );
    try {
      await n.sendRawTransaction(d, I);
    } catch (M) {
      console.error("Failed to resend transaction:", M);
    }
  }
  if (r.value.err) {
    let M = `Transaction failed: ${r.value.err}`;
    if (typeof r.value.err == "object")
      try {
        M = `Transaction failed: ${JSON.stringify(
          r.value.err,
          (L, j) => typeof j == "bigint" ? j.toString() : j
          // Handle bigint props
        )}`;
      } catch {
        M = "Transaction failed: Unknown error";
      }
    throw new Error(`Transaction failed: ${M}`);
  }
  return g;
}
export {
  Ee as fetchOptions,
  Ce as signAndSendTransaction
};
