...
import { ch as v, ci as f, cj as x, cf as I, ck as A, b2 as w, bw as U, b9 as $, bx as m, r as o, ay as k, p as c, m as h, cl as C, bC as T, O as E, bz as F, k as _, ba as u, cm as O, bf as W } from "./index-CGIqRhuR.mjs";
import { A as N } from "./unsignedTransaction-BDOQhqcZ.mjs";
import { A as Q } from "./aptos-D3MPi63x.mjs";
const R = [
...
class d {
  ...
  async *transfer(e, t, s, r, n) {
    const B = 0n, p = 0n, y = h(s) ? _ : s.toString(), l = t.address.toUniversalAddress().toUint8Array(), g = w(t.chain);
    n ? yield this.createUnsignedTx({
      function: `${this.tokenBridgeAddress}::transfer_tokens::transfer_tokens_with_payload_entry`,
      typeArguments: [y],
      functionArguments: [r, g, l, p, n]
  ...
  async getAssetFullyQualifiedType(e) {
    return e.chain === this.chain ? O(e.address.toString()) ? e.address.toString() : null : `${d.getForeignAssetAddress(this.chain, this.tokenBridgeAddress, e)}::coin::T`;
  }
  /**
  ...
  createUnsignedTx(e, t, s = !1) {
    return new N(e, this.network, this.chain, t, s);
  }
}
W("Aptos", "TokenBridge", d);
export {
