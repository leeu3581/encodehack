import { amount, contracts, finality, guardians, } from "@wormhole-foundation/sdk-base";
import { ManualRoute } from "../route.js";
import { deserialize, isNative, isSameToken, serialize, TBTCBridge, } from "@wormhole-foundation/sdk-definitions";
import { isAttested, isSourceFinalized, isSourceInitiated, TransferState, } from "../../types.js";
import { Wormhole } from "../../wormhole.js";
import { signSendWait } from "../../common.js";
export class TBTCRoute extends ManualRoute {
    static meta = {
        name: "ManualTBTC",
    };
    ...
    async quote(request, params) {
        const eta = finality.estimateFinalityTime(request.fromChain.chain) + guardians.guardianAttestationEta;
        return {
            success: true,
            params,
            sourceToken: {
    ...
    async transferWrapped(request, signer, to, amt) {
        ...
        if (toGateway) {
            ...
            xfer = tb.transfer(sender, Wormhole.chainAddress(request.toChain.chain, toGateway), request.source.id.address, amt, 
