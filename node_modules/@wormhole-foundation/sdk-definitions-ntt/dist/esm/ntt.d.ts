...
export declare namespace Ntt {
    ...
    export type TransceiverRegistration = NttManagerMessage<typeof transceiverRegistration>;
...
export interface SolanaNttTransceiver<N extends Network, C extends Chain, A extends Ntt.Attestation> extends NttTransceiver<N, C, A> {
    programId: PublicKey;
}
export interface EvmNttTransceiver<N extends Network, C extends Chain, A extends Ntt.Attestation> extends NttTransceiver<N, C, A> {
}
